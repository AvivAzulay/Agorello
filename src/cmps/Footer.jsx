...
<div className="presentors-imgs">
        ...
        <div className="presentor">
        <div className="presentors-img" style={{ backgroundImage: `url("https://res.cloudinary.com/taskit-sprint/image/upload/v1622668300/members%20taskit/oded_i8t6vj.jpg")` }}></div>
        <h1>Oded Alon </h1>
        </div>
        <div className="presentor">
